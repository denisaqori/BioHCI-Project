...
class StudyConfig(object):
    ...
    def _load(self, toml_config_file: str) -> None:
        """
    ...
    def dump(self, study_parameters: StudyParameters, toml_config_file: str) -> None:
        """
        Creates a configuration file based on the attributes of the StudyParameters object passed.

        Args:
            study_parameters: a StudyParameters instance containing key-value pairs
            toml_config_file (str): the name of the configuration file to be created based on the previous argument
    ...
    def populate_study_parameters(self, toml_config_file: str) -> StudyParameters:
        """
        ...
        # creates a StudyParameters class with attributes set according to the internal dictionary
        parameters = StudyParameters(self.settings_dict)
        print("\nThe StudyParameters object has been populated using the configuration file: ", self.configFileUsed)

        return parameters

    def create_config_file_template(self) -> None:
        """
