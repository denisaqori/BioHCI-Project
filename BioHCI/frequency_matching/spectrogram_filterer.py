...
class Spectrogram_Filterer:
	...
	def get_strongest_freq(self, populated_bands, num_freq=10):
		"""
		...
		Args:
			...
			num_freq (int): the number of maximum intensity points to keep in each band
